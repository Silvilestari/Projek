...
<html lang="en">
    ...
    <tr>
        ...
        <header class="bg-dark py-5">
                <div class="text-right text-white">
                    <h1 class="display-7 fw-bolder"><center>Daftar Menu</center></h1>
                </div>
            </div>
        </header>
        <br>
  <h3><center>-- Menu Makanan --</h3>
  <div class="col-sm-10 text-center">
      <center><br>
  <table border="2" width="60%"><center>
  <tr>
    <th>No</th>
    <th>Foto</th>
    <th>Menu</th>
  ...
  while($data = $sql->fetch()){ // Ambil semua data dari hasil eksekusi $sql
    ...
    echo "<td><a href='hapus_menu.php?id=".$data['id']."'>Hapus</a></td>";
    echo "</tr>";
  }
  ?>
  </div>
